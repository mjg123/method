...
* [`src/method/styles.cljs`](src/method/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/method/`](src/method/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/method/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `method` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/method/config.cljs) defaults to `true` in
...
```clj
(ns method.example
  (:require [method.config :as config])
